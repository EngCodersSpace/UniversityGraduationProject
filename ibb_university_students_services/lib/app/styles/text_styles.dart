...
class AppTextStyles {
  ...
  static TextStyle secStyle(TextHeaders h3,
  ...
  static TextStyle failedGrads({TextHeaders? textHeader, double? height}) {
    textHeader ??= AppTextHeaders.h2;
    return TextStyle(
      fontSize: Responsivity.fontSizeScale(textHeader.fontSize),
      fontWeight: textHeader.fontWeight,
