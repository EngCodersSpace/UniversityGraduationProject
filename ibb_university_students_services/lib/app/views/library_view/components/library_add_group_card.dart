...
class AddGroupCard extends GetView<LibraryController> {
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Obx(
                                      () => DropdownButton(
                                    items: controller.levels.keys.where((t)=>t!=-1).map((e){
                                      return DropdownMenuItem<int>(
                                          value: e,
                                          child: SizedBox(
                                    ...
                                    value:(selectedLevel.value ==-1)?null:selectedLevel.value,
                                    underline: const SizedBox(),
                                    iconEnabledColor: AppColors.mainCardColor,
                                    dropdownColor: AppColors.inverseCardColor,
                                  ),
                        ...
                        Row(
                          ...
                          children: [
                            CustomButton(
                              onPress: (){
                                controller.addGroup(selectedDepartment.value!, selectedLevel.value!);
