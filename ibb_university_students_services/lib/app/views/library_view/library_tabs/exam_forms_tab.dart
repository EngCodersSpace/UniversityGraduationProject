...
class ExamFormsTab extends GetView<LibraryController> {
  const ExamFormsTab({super.key});
        ...
        child: Obx(
          () => (controller.loadingState.value)
              ...
              : PageView(
                  ...
                  children: [
                    if (controller.books[controller.categories[2]]
                        ?.isEmpty ??
                        true) ...[
                      RefreshIndicator(
                    ...
                    for (int i = 0;
                        i <
                            (controller
                                    .books[controller.categories[2]]?.length ??
                                0);
                        i += 12)
                      RefreshIndicator(
                        onRefresh: () async => controller.refresh(),
                                          ...
                                          j < (i + 12) &&
                                              (j <
                                                  (controller.books[controller.categories[2]]?.length ??
                                                      0));
                                          j++)
                                        if ((controller.books[controller.categories[2]]?.values
                                                        .toList()[i]
                                                        .sectionId ==
                                                    controller
                                                        .selectedDepartment
                                                ...
                                                controller.selectedDepartment.value ==
                                                    -1) &&
                                            (controller.books[controller.categories[2]]?.values
                                                        .toList()[i]
                                                        .levelId ==
                                                    controller
                                                        .selectedLevel.value ||
