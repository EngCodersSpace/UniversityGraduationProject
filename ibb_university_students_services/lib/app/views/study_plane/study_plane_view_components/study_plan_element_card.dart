            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    CustomText(
                      "${"Subject".tr}:",style: AppTextStyles.mainStyle(textHeader: AppTextHeaders.h1Bold,),textAlign: TextAlign.center,),
                    SizedBox(width: 8,),
                    CustomText(
                      studyPlanElement.value.subject?.subjectName ?? "Unknown".tr,style: AppTextStyles.mainStyle(textHeader: AppTextHeaders.h2Bold,),textAlign: TextAlign.center,),
                  ],
                ),
                SizedBox(height: 8,),
                CustomText(
                  "${"Description".tr}:",style: AppTextStyles.mainStyle(textHeader: AppTextHeaders.h1Bold,),textAlign: TextAlign.center,),
                Row(
                  children: [
                    SizedBox(width: 8,),
                    Flexible(
                      child: CustomText(
                        studyPlanElement.value.subject?.description ?? "Unknown".tr,style: AppTextStyles.mainStyle(textHeader: AppTextHeaders.h2Bold,),textAlign: TextAlign.center,),
                    ),
                  ],
                ),
              ],
