                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    Center(
                                      child: CustomText(
                                        "الدرجة الأكادمية:   ${((controller.user?.value as Doctor).academicDegreeData?["ar"])}",
                                          style: AppTextStyles.customColorStyle(color: Colors.black, textHeader: AppTextHeaders.h2Bold)
                                      ),
                                    ),
                                    const SizedBox(height: 8,),
                                    Center(
                                      child: CustomText(
                                          "الدرجة الوظيفية:   ${((controller.user?.value as Doctor).administrativePositionData?["ar"])}",
                                          style: AppTextStyles.customColorStyle(color: Colors.black, textHeader: AppTextHeaders.h2Bold)
                                      ),
                                    ),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8)),
                        child: Center(
                          child: CustomText((controller.user?.value as Doctor).dateOfBrith?.split("T").first??"??",
                              style: AppTextStyles.customColorStyle(color: Colors.white, textHeader: AppTextHeaders.h2Bold)
                          ),
                        ),
                      ),
