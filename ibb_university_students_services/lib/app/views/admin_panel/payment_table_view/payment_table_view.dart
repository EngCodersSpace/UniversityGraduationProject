...
import 'package:ibb_university_students_services/app/views/admin_panel/payment_table_view/payment_table_component/payment_table_filter_component.dart';

class PaymentTableView extends GetView<DashboardPaymentTableController> {
  const PaymentTableView({super.key});
        ...
        child: Column(
          children: [
            HeaderOfViewComponent(
                tableName: "Student Fee", controller: controller),
            SizedBox(
              height: controller.height * 0.01,
            ),
            PaymentTableFilterComponent(),
            SizedBox(
              height: controller.height * 0.01,
            ),
            Expanded(
              child: Scrollbar(
                ...
                child: SingleChildScrollView(
                  controller: controller.vertical,
                  child: GetBuilder<DashboardPaymentTableController>(
                    id: "DataTable",
...
class MyData extends DataTableSource {
  final DashboardPaymentTableController controller =
      Get.find<DashboardPaymentTableController>(); // GetX Controller
        ...
        cells: [
          ...
          DataCell(
              ...
              CustomTextFormField(
                  ...
                  enableBorder: false,
                  initialValue:
                      items[index % controller.rowsPerPage.value].paymentDate)),
          DataCell(
              onTap: () {},
              CustomTextFormField(
                  key: UniqueKey(),
  ...
  List<StudentFee> get items => controller.studentFee.values.toList();
  @override
